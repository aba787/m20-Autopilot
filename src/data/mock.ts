...
export const products = [
  { id: 1,  name: 'Luxury Sleep Pillow - Anti-Allergy - King Size',    asin: 'B0CK82XYLP', brand: 'LuxeSleep',    price: 189, sales: 34500, cost: 8200,  profit: 12400, units: 182, acos: 23.7, status: 'active', keywords: ['sleep pillow', 'luxury pillow', 'anti-allergy pillow'],     negKeywords: ['cheap pillow', 'kids pillow'] },
  { id: 2,  name: 'Natural Moisturizing Cream with Argan Oil 200ml',   asin: 'B0BX9MNKRT', brand: 'NatureCare',   price: 95,  sales: 28900, cost: 6100,  profit: 9800,  units: 304, acos: 21.1, status: 'active', keywords: ['moisturizer', 'argan oil', 'skin hydration'],              negKeywords: ['cheap cream', 'mens cream'] },
  { id: 3,  name: 'Wireless Bluetooth Headphones with Noise Cancelling', asin: 'B0D3FKLP22', brand: 'SoundMax',  price: 349, sales: 52000, cost: 15600, profit: 18200, units: 149, acos: 30.0, status: 'active', keywords: ['bluetooth headphones', 'wireless headphones', 'noise cancelling'], negKeywords: ['wired headphones', 'cheap headphones'] },
  { id: 4,  name: 'Luxury Men\'s Oud Noir Perfume 100ml',              asin: 'B0CDK39MXP', brand: 'ArabiScents', price: 420, sales: 41000, cost: 12300, profit: 15600, units: 97,  acos: 30.0, status: 'active', keywords: ['mens perfume', 'oud perfume', 'luxury fragrance'],         negKeywords: ['womens perfume', 'cheap perfume'] },
  { id: 5,  name: 'Professional Steam Hair Straightener Ceramic 230°C', asin: 'B0BZ7WQPKY', brand: 'StylePro',   price: 265, sales: 18400, cost: 5200,  profit: 6100,  units: 69,  acos: 28.3, status: 'active', keywords: ['hair straightener', 'steam iron', 'ceramic flat iron'],     negKeywords: [] },
  { id: 6,  name: 'Rolling Travel Luggage 24 Inch - Blue',             asin: 'B0CFP8LQZX', brand: 'TravelMate', price: 310, sales: 8200,  cost: 3800,  profit: 1200,  units: 26,  acos: 46.3, status: 'weak',   keywords: ['travel luggage', 'suitcase'],                               negKeywords: ['cheap luggage'] },
  { id: 7,  name: 'SPF 50+ Sunscreen for Oily Skin 50ml',              asin: 'B0CL8KPQMN', brand: 'SunGuard',   price: 78,  sales: 22000, cost: 5500,  profit: 8200,  units: 282, acos: 25.0, status: 'active', keywords: ['sunscreen', 'sun cream', 'SPF 50'],                        negKeywords: [] },
  { id: 8,  name: 'Smart Sports Watch with Blood Pressure Monitor',    asin: 'B0BYK4MNZP', brand: 'FitTech',    price: 520, sales: 31000, cost: 9300,  profit: 11400, units: 59,  acos: 30.0, status: 'active', keywords: ['smart watch', 'sports watch', 'blood pressure monitor'],   negKeywords: ['cheap watch'] },
  { id: 9,  name: 'Moroccan Argan Oil Hair Treatment 100ml',           asin: 'B0CMNLPQWX', brand: 'MarocBeauty', price: 115, sales: 19800, cost: 4200, profit: 7900,  units: 172, acos: 21.2, status: 'active', keywords: ['argan oil', 'hair oil', 'hair treatment'],                 negKeywords: [] },
  { id: 10, name: 'Lightweight Cordless Vacuum - Car & Home',          asin: 'B0CPX7ZNMK', brand: 'CleanPro',   price: 198, sales: 4100,  cost: 2900,  profit: -380,  units: 20,  acos: 70.7, status: 'poor',   keywords: ['vacuum cleaner', 'cordless vacuum'],                       negKeywords: ['cheap vacuum'] },
  { id: 11, name: '5-Piece Stainless Steel Cookware Set',              asin: 'B0CQK2XZPN', brand: 'ChefMate',   price: 245, sales: 15600, cost: 4700,  profit: 5200,  units: 63,  acos: 30.1, status: 'active', keywords: ['cookware', 'frying pan', 'cooking pot'],                   negKeywords: [] },
  { id: 12, name: 'Python Programming for Beginners - Paperback',      asin: 'B0CRZ8MQKP', brand: 'TechBooks',  price: 65,  sales: 3200,  cost: 1200,  profit: 820,   units: 49,  acos: 37.5, status: 'weak',   keywords: ['programming book', 'learn python'],                        negKeywords: [] },
];
