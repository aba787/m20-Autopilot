  ...
  <div class="email-wrapper">
    ...
    <div class="footer">
      <p>© ${new Date().getFullYear()} M20 Autopilot. All rights reserved.</p>
              <p><a href="https://www.m20autopilot.com/settings">Unsubscribe</a> · <a href="https://www.m20autopilot.com/settings">Email Preferences</a></p>
    </div>
  </div>
</body>
</html>`;
...
function welcomeTemplate(name: string) {
  ...
  return baseLayout(`
    ...
    <div style="text-align:center; margin-top:24px;">
              <a href="https://www.m20autopilot.com/dashboard" class="btn">Go to Dashboard →</a>
    </div>
...
function announcementTemplate(name: string, subject: string, contentHtml: string) {
  ...
  return baseLayout(`
    ...
    <div style="text-align:center; margin-top:24px;">
              <a href="https://www.m20autopilot.com/dashboard" class="btn">Open Dashboard →</a>
    </div>
  `, subject);
}
