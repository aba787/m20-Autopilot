              ...
              <tbody>
                {items.map(item => (
                  <tr key={item.id} style={{ borderBottom: '1px solid var(--border-subtle)' }}>
                    ...
                    <td className="py-3 px-4 font-mono text-xs" style={{ color: 'var(--text-dim)' }}>{item.asin}</td>
                    ...
                    <td className="py-3 px-4 text-xs" style={{ color: 'var(--text-dim)' }}>{item.date}</td>
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-1">
                        ...
                        <button onClick={() => remove(item.id)} title="Delete permanently"
                          className="p-1.5 rounded transition-colors" style={{ color: 'var(--error)' }}>
