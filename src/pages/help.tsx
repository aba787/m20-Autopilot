    ...
    <div className="space-y-5 max-w-2xl">
      <div>
        <h1 className="text-xl font-bold text-white flex items-center gap-2">
          <HelpCircle className="w-5 h-5" style={{ color: 'var(--accent)' }} /> Help Center
        </h1>
        <p className="text-sm" style={{ color: 'var(--text-muted)' }}>Answers to frequently asked questions</p>
      </div>
      ...
      {filtered.length === 0 && (
        <div className="p-10 text-center" style={CARD}>
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>Try a different search term or contact us directly.</p>
        </div>
      )}
      ...
      <div className="p-4 text-center" style={CARD}>
        ...
        <p className="text-xs mb-3" style={{ color: 'var(--text-dim)' }}>Our support team is ready to help</p>
        <a href="/support"
