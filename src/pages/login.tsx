  ...
  return (
    <>
      ...
      <style>{`
        ...
        .__bg-fallback{position:fixed;inset:0;z-index:0;background:url('/login-bg.jpg') center/cover no-repeat;background-color:#05080f;}
        ...
        .__tint{position:fixed;inset:0;z-index:1;background:radial-gradient(ellipse 70% 60% at 50% 50%,rgba(2,6,16,.78) 0%,rgba(3,9,22,.62) 45%,rgba(2,6,16,.55) 100%),linear-gradient(160deg,rgba(3,10,25,.80) 0%,rgba(5,14,35,.86) 50%,rgba(2,8,20,.78) 100%);}
