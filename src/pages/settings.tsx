          ...
          <div>
            ...
            <p className="text-xs" style={{ color: 'var(--text-dim)' }}>
              {t('settings.deleteDesc')}
                      ...
                      <button onClick={() => { window.location.href = 'mailto:support@m20autopilot.com?subject=Account%20Deletion%20Request'; }} className="text-sm px-3 py-1.5 rounded transition-colors"            style={{ color: 'var(--error)', border: '1px solid rgba(239,68,68,0.3)' }}>
