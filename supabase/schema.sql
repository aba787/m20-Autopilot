-- ============================================================
-- ⚠️ DEPRECATED / LEGACY SCHEMA — DO NOT RUN ON PRODUCTION
-- This file is kept for historical reference only.
-- The authoritative, up-to-date schema is: supabase/fix-and-seed.sql
-- Notable differences: this legacy file still has password_hash NOT NULL,
-- lacks RLS policies, the role column, and the subscriptions table.
-- ============================================================
